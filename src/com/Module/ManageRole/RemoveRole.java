...
public class RemoveRole extends TestBaseD {
    @Test
    public void REMOVE_ROLE() throws IOException, InterruptedException {
        test = extent.createTest("REMOVE ROLE");
        ...
        Thread.sleep(2000);
        WebElement elementuu = driver.findElement(By.xpath(Utility.fetchLocator("RoleRemoveBTN_XPATH")));
